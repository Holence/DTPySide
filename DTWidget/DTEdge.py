...
class DTEdge(QWidget):
    def __init__(self, parent, position, disable_color = False):
        ...
        if position == Qt.TopEdge:
            self.wi.top(self)
            self.setGeometry(0, 0, self.parent.width(), WIDTH)
        ...
        # SHOW BOTTOM GRIP
            ...
            self.wi.bottom(self)
            self.setGeometry(0, self.parent.height() - WIDTH, self.parent.width(), WIDTH)
            self.setMaximumHeight(WIDTH)
        ...
        # SHOW LEFT GRIP
            ...
            self.wi.left(self)
            self.setGeometry(0, WIDTH, WIDTH, self.parent.height())
        ...
        # RESIZE RIGHT
            ...
            self.wi.right(self)
            self.setGeometry(self.parent.width() - WIDTH, WIDTH, WIDTH, self.parent.height())
            self.setMaximumWidth(WIDTH)
    ...
    def resizeEvent(self, event):
        if hasattr(self.wi, 'container_top'):
            self.wi.container_top.setGeometry(0, 0, self.width(), WIDTH)

        elif hasattr(self.wi, 'container_bottom'):
            self.wi.container_bottom.setGeometry(0, 0, self.width(), WIDTH)

        elif hasattr(self.wi, 'leftgrip'):
            self.wi.leftgrip.setGeometry(0, 0, WIDTH, self.height() - WIDTH*2)

        elif hasattr(self.wi, 'rightgrip'):
            self.wi.rightgrip.setGeometry(0, 0, WIDTH, self.height() - WIDTH*2)
...
class Widgets(object):
    def top(self, Form):
        ...
        self.container_top.setGeometry(QRect(0, 0, 500, WIDTH))
        self.container_top.setMinimumSize(QSize(0, WIDTH))
        self.container_top.setMaximumSize(QSize(16777215, WIDTH))
        ...
        self.top_left.setMinimumSize(QSize(WIDTH, WIDTH))
        self.top_left.setMaximumSize(QSize(WIDTH, WIDTH))
        ...
        self.top_right.setMinimumSize(QSize(WIDTH, WIDTH))
        self.top_right.setMaximumSize(QSize(WIDTH, WIDTH))
    ...
    def bottom(self, Form):
        ...
        self.container_bottom.setGeometry(QRect(0, 0, 500, WIDTH))
        self.container_bottom.setMinimumSize(QSize(0, WIDTH))
        self.container_bottom.setMaximumSize(QSize(16777215, WIDTH))
        ...
        self.bottom_left.setMinimumSize(QSize(WIDTH, WIDTH))
        self.bottom_left.setMaximumSize(QSize(WIDTH, WIDTH))
        ...
        self.bottom_right.setMinimumSize(QSize(WIDTH, WIDTH))
        self.bottom_right.setMaximumSize(QSize(WIDTH, WIDTH))
    ...
    def left(self, Form):
        ...
        self.leftgrip.setGeometry(QRect(0, WIDTH, WIDTH, 480))
        self.leftgrip.setMinimumSize(QSize(WIDTH, 0))
    ...
    def right(self, Form):
        ...
        self.rightgrip.setGeometry(QRect(0, 0, WIDTH, 500))
        self.rightgrip.setMinimumSize(QSize(WIDTH, 0))
