...
from DongliTeahousePySideWheel.DongliTeahousePalette import DongliTeahouseDarkPalette
from DongliTeahousePySideWheel.DongliTeahouseSession import DongliTeahouseLoginSession
...
class DongliTeahouseAPP(QApplication):
	...
	def __init__(self,args):
		...
		self.setPalette(DongliTeahouseDarkPalette())
	...
	def __loginIn(self):
		dlg=DongliTeahouseLoginSession(self.UserSetting.value("BasicInfo/Password"))
		if dlg.exec_()==0:
			self.quit()
			exit()
		else:
