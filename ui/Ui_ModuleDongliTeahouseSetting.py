...
class Ui_Module_DongliTeahouseSetting(object):
    def setupUi(self, Module_DongliTeahouseSetting):
        ...
        self.listWidget_buttons.setMinimumSize(QSize(75, 0))
        self.listWidget_buttons.setMaximumSize(QSize(75, 16777215))
        ...
        self.listWidget_buttons.setVerticalScrollBarPolicy(Qt.ScrollBarAlwaysOn)
        ...
        self.listWidget_buttons.setSpacing(12)
