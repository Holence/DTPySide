...
class Ui_DTSetting(object):
    def setupUi(self, DTSetting):
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_country.sizePolicy().hasHeightForWidth())
        self.pushButton_country.setSizePolicy(sizePolicy1)

        self.gridLayout.addWidget(self.pushButton_country, 16, 1, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_language.sizePolicy().hasHeightForWidth())
        self.pushButton_language.setSizePolicy(sizePolicy1)

        self.gridLayout.addWidget(self.pushButton_language, 14, 1, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_password.sizePolicy().hasHeightForWidth())
        self.pushButton_password.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_window_effect.sizePolicy().hasHeightForWidth())
        self.pushButton_window_effect.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_theme.sizePolicy().hasHeightForWidth())
        self.pushButton_theme.setSizePolicy(sizePolicy1)
        ...
        self.slider_Hue.setSingleStep(1)
        self.slider_Hue.setPageStep(60)
        self.slider_Hue.setOrientation(Qt.Horizontal)

        self.gridLayout.addWidget(self.slider_Hue, 12, 0, 1, 1)
