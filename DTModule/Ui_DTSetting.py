...
class Ui_DTSetting(object):
    def setupUi(self, DTSetting):
        ...
        self.scrollAreaWidgetContentsBasicInfo.setGeometry(QRect(0, 0, 841, 659))
        ...
        self.gridLayout.addWidget(self.label_language, 14, 0, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.pushButton_backup.sizePolicy().hasHeightForWidth())
        self.pushButton_backup.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.slider_Hue, 13, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_country, 17, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_language, 15, 0, 1, 1)
        ...
        self.pushButton_hue = DTApplyButton(self.scrollAreaWidgetContentsBasicInfo)
        self.pushButton_hue.setObjectName(u"pushButton_hue")
        sizePolicy2.setHeightForWidth(self.pushButton_hue.sizePolicy().hasHeightForWidth())
        self.pushButton_hue.setSizePolicy(sizePolicy2)

        self.gridLayout.addWidget(self.pushButton_hue, 13, 1, 1, 1)
        ...
        self.horizontalLayout_hue = QHBoxLayout()
        self.horizontalLayout_hue.setObjectName(u"horizontalLayout_hue")
        ...
        self.horizontalLayout_hue.addItem(self.horizontalSpacer)


        self.gridLayout.addLayout(self.horizontalLayout_hue, 12, 0, 1, 1)
