...
class DemoSettingSession(DTSession.DTSettingSession):
	def __init__(self, Headquarter, app):
		...
		MenuButton1=DTWidget.DTSettingButton(QIcon(":/icon/white/white_at-sign.svg"),self.font().pointSize())
		self.addButtonAndPage(MenuButton1,self.SettingPages.page_1)
		
		MenuButton2=DTWidget.DTSettingButton(QIcon(":/icon/white/white_anchor.svg"),self.font().pointSize())
