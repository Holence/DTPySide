...
################################################################################
## Form generated from reading UI file 'Ui_DongliTeahouseSetting.ui'
##
...
class Ui_DongliTeahouseSetting(object):
    def setupUi(self, DongliTeahouseSetting):
        if not DongliTeahouseSetting.objectName():
            DongliTeahouseSetting.setObjectName(u"DongliTeahouseSetting")
        DongliTeahouseSetting.resize(538, 383)
        self.horizontalLayout = QHBoxLayout(DongliTeahouseSetting)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.listWidget_buttons = QListWidget(DongliTeahouseSetting)
        ...
        self.stackedWidget = QStackedWidget(DongliTeahouseSetting)
        ...
        self.retranslateUi(DongliTeahouseSetting)

        self.stackedWidget.setCurrentIndex(0)


        QMetaObject.connectSlotsByName(DongliTeahouseSetting)
    # setupUi

    def retranslateUi(self, DongliTeahouseSetting):
        DongliTeahouseSetting.setWindowTitle(QCoreApplication.translate("DongliTeahouseSetting", u"DongliTeahouseSetting", None))
        self.pushButton_password.setText(QCoreApplication.translate("DongliTeahouseSetting", u"Apply", None))
        self.label_font.setText(QCoreApplication.translate("DongliTeahouseSetting", u"Font", None))
        self.label_password.setText(QCoreApplication.translate("DongliTeahouseSetting", u"Password", None))
        self.pushButton_font.setText(QCoreApplication.translate("DongliTeahouseSetting", u"Font", None))
    # retranslateUi
