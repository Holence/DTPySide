...
from DongliTeahousePySideWheel.DongliTeahouseModule import DongliTeahouseSetting

# Setting
class DongliTeahouseSettingSession(DongliTeahouseDialog):
	def __init__(self,parent):
		...
		self.__settingModule=DongliTeahouseSetting(parent)
